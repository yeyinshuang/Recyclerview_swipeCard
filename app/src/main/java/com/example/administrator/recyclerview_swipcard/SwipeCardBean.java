package com.example.administrator.recyclerview_swipcard;
...
public class SwipeCardBean {
    ...
    public static List<SwipeCardBean> initDatas() {
        ...
        datas.add(new SwipeCardBean(i++, "http://img5q.duitang.com/uploads/item/201309/17/20130917032356_hdGjF.thumb.700_0.jpeg","美女9"));
        datas.add(new SwipeCardBean(i++, "http://img5q.duitang.com/uploads/item/201309/17/20130917032356_hdGjF.thumb.700_0.jpeg","美女10"));
        datas.add(new SwipeCardBean(i++, "http://img5q.duitang.com/uploads/item/201309/17/20130917032356_hdGjF.thumb.700_0.jpeg","美女11"));
        return datas;
    }
}
